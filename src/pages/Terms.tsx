    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 pb-16">
        <div className="container max-w-3xl prose prose-sm">
          ...
          {[
            { t: "1. Acceptance of Terms", p: "By accessing TripAI, you agree to be bound by these Terms of Service and all applicable laws." },
            ...
            { t: "5. Limitation of Liability", p: "TripAI acts as an intermediary and is not liable for services provided by third-party suppliers." },
          ].map((s) => (
