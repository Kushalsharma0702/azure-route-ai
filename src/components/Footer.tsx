      ...
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/60">
              <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> hello@tripai.in</li>
        ...
        <div className="border-t border-primary-foreground/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-primary-foreground/40">© 2026 TripAI India. All rights reserved.</p>
