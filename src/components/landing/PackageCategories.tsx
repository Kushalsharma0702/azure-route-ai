  ...
  return (
    <section className="py-24 bg-card">
      <div className="container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3">Holiday Packages Across India</h2>
          <p className="text-muted-foreground">Curated travel packages for every kind of Indian traveler</p>
        </motion.div>
